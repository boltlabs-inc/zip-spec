...
A merchant should be able to close the channel by posting their closing token or revocation signature if they disagree with the state posted by the customer.
