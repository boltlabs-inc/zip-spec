...
* ``txin`` count: 1
   ...
   - ``txin[0]`` script sig: 0 <channel-token> <channel-pubkey> <cust-sig> <merch-sig> <2 <cust_fund_pubkey> <merch_fund_pubkey> 2 OP_CHECKMULTISIGVERIFY OP_DUP OP_HASH160 <hash-of-channel-token> OP_EQUALVERIFY OP_BOLT>
