::
  ...
  ZIP: XXX
  Title: Enabling Blind Off-chain Lightweight Transactions (Bolt) protocol using shielded/transparent features
...
1. Transparent/Shielded Tx: Using T/Z-addresses and Scripting Opcodes
-------------

Using a mix of shielded and transparent transactions, we need have the following requirements:
...
(4) Ability to validate Bolt-specific channel opening and closing signature:
